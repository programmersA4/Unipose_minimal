...
def draw_paint(im, kpts, mapNumber, epoch, model_arch, dataset):
    ...
    if dataset == "LSP":
        ...
        # limbSeq = [[ 8, 9], [ 7,12], [12,11], [11,10], [ 7,13], [13,14], [14,15], [ 7, 6], [ 6, 2], [ 2, 1], [ 1, 0], [ 6, 3], [ 3, 4], [ 4, 5], [ 7, 8]]
                #    HEAD    R.SLDR  R.BICEP  R.FRARM   L.SLDR  L.BICEP     HIP     TORSO    L.BODY   L.THIGH   L.CALF    R.BODY   R.THIGH  R.CALF   EXT.HEAD
        limbSeq = [[ 0, 0], [ 5, 7], [ 7, 9], [ 9, 9], [ 4, 6], [ 6, 8], [11,10], [ 4, 5], [ 4,10], [10,12], [12,14], [ 5,11], [11,13], [13,15], [ 2, 2]]
